<?php
	...
	$query = "INSERT INTO $tbl2 (userId, childNum, firstName, lastName, birth, grade, school, sessionNum, sessionLength, phone, email) VALUES ('$id', '$numEnrolled', '$childfirst', '$childlast', '$birth', '$grade', '$school', '$session', '$length', '$phone', '$email')";
